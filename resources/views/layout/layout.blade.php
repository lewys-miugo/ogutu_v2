                ...
                <div class="mt-8 space-y-4 lg:mt-0">
                    ...
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
                        ...
                        <form target="_blank" 
                          ...
                          action="https://formsubmit.co/mogutu005@gmail.com" 
                          
                          method="POST">
                          <div class="form-group mb-6">
                            <input type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="name" name="name"
                              placeholder="Name">
                          </div>
                          <div class="form-group mb-6">
                            <input type="email" name="email" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8"
                              placeholder="Email address" required>
                          </div>
                          <div class="form-group mb-6">
                            <textarea name="message"
                            class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700
                              bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleFormControlTextarea13"
                            rows="3"
                            placeholder="Message"
                          ></textarea>
                          </div>
                    ...
                    <div>
                        ...
                        <nav aria-label="Footer Navigation - Services" class="mt-6">
                            ...
                            <ul class="space-y-4 text-sm">
                                ...
                                <li><a href="{{url('/publications')}}" class="text-gray-700 transition hover:opacity-75">Publications</a>
                                </li>
                                ...
                                @foreach($contact as $contact)
                                    <li>
                                      @if($contact->type=="social")
                                        <a href="{{$contact->value}}" class="text-gray-700 transition hover:opacity-75">{{$contact->name}}
                                        </a>
